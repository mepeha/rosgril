...
$header_phone = trim((string) ($contact_data['phone'] ?? ''));
$header_phone_href = trim((string) ($contact_data['phone_href'] ?? ''));

if ($header_phone === '') {
    $header_phone = '+7(982) 613-24-16';
}

if ($header_phone_href === '') {
    $header_phone_href = 'tel:+79826132416';
}
?>
...
<header class="header">
  <div class="container">
      ...
      <div class="header__area">
        ...
        <a href="<?php echo esc_url($header_phone_href); ?>" class="number">
